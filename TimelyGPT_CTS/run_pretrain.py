import os
import numpy as np
from models.TimelyGPT import TimelyGPT
import argparse
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='TimelyGPT for pretraining continuous biosignals')
    ...
    parser.add_argument('--model', type=str, default='TimelyGPT', help='model name, options: [TimelyGPT]')

    # dataset_small loader
    parser.add_argument('--data', type=str, default='custom', help='continuous time series data')
    ...
    parser.add_argument('--c_in', type=int, default=1, help='number of variates')
    parser.add_argument('--n_class', type=int, default=1, help='number of class')
    parser.add_argument('--reg_dim', type=int, default=1, help='dimension of regression')


    # the hyperparameters for TimelyGPT
    ...
    test_data, test_loader = data_pipeline(data_path, flag='test')
    ...
    for epoch in range(train_epochs):
        ...
        # no need testing for pre-training stage
        # model.eval()
        # test_loss = []
        # with torch.no_grad():
