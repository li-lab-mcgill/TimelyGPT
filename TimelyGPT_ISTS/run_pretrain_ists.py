...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='TimelyGPT for pretraining PopHR irregularly-sampled time series')
    ...
    parser.add_argument('--data', type=str, default='custom', help='PopHR irregularly-sampled time series')
